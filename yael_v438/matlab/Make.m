...
mex -g -largeArrayDims -DFINTEGER=long -lmwblas -lmwlapack -lmwarpack CFLAGS="\$CFLAGS -msse4 -I.. -Wall -O3 -DHAVE_ARPACK " LDFLAGS="\$LDFLAGS" yael_eigs.c ../yael/eigs.c ../yael/vector.c ../yael/matrix.c ../yael/machinedeps.c ../yael/sorting.c ../yael/binheap.c ;
mex -g -largeArrayDims -DFINTEGER=long -lmwblas -lmwlapack -lmwarpack CFLAGS="\$CFLAGS -msse4 -I.. -Wall -O3 -DHAVE_ARPACK " LDFLAGS="\$LDFLAGS  -lmwarpack" yael_svds.c ../yael/eigs.c ../yael/vector.c ../yael/matrix.c ../yael/machinedeps.c ../yael/sorting.c ../yael/binheap.c ;
mex -g -largeArrayDims -DFINTEGER=long -lmwblas -lmwlapack -lmwarpack CFLAGS="\$CFLAGS -msse4 -I.. -Wall -O3 -DHAVE_ARPACK " LDFLAGS="\$LDFLAGS  -lmwarpack" yael_gmm.c ../yael/gmm.c ../yael/kmeans.c ../yael/vector.c ../yael/matrix.c ../yael/eigs.c ../yael/machinedeps.c ../yael/binheap.c ../yael/nn.c ../yael/sorting.c ;
mex -g -largeArrayDims -DFINTEGER=long -lmwblas -lmwlapack -lmwarpack CFLAGS="\$CFLAGS -msse4 -I.. -Wall -O3 -DHAVE_ARPACK " LDFLAGS="\$LDFLAGS  -lmwarpack" yael_fisher.c ../yael/gmm.c ../yael/kmeans.c ../yael/vector.c ../yael/matrix.c ../yael/eigs.c ../yael/machinedeps.c ../yael/binheap.c ../yael/nn.c ../yael/sorting.c ;
mex -g -largeArrayDims -DFINTEGER=long -lmwblas -lmwlapack -lmwarpack CFLAGS="\$CFLAGS -msse4 -I.. -Wall -O3 -DHAVE_ARPACK " LDFLAGS="\$LDFLAGS  -lmwarpack" yael_fisher_elem.c ../yael/gmm.c ../yael/kmeans.c ../yael/vector.c ../yael/matrix.c ../yael/eigs.c ../yael/machinedeps.c ../yael/binheap.c ../yael/nn.c ../yael/sorting.c ;
